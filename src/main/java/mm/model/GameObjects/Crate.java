...
public class Crate extends PhysicalGameObject {
    private static final float WIDTH = 0.3f;
    private static final float HEIGHT = 0.3f;

    private static final Image sprite = new Image(ResourceLoader.getResource("/sprites/Crate.png").toExternalForm());
    private final BodyDef bodyDef = new BodyDef();
    private final PolygonShape shape;

    /**
     * Constructor for Crate object
     */
    public Crate() {
    ...
    public void instantiate(World world) {
        ...
        physicsObject.createFixture(shape, 2.0f);
    }
